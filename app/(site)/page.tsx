...
export default async function Home() {
  ...
  return (
    <div className="pb-10">
      <HeroSimple
        title="INFJ程序员的奇思妙想和实践 🌴."
        subtitle="I'm YeWeiRui. Frontend engineer writing code and blog on the internet."
      />
      ...
      {aboutPage && (
        <div className="container max-w-6xl">
          <h2 className="mb-8 font-heading text-4xl font-bold">Who am I?</h2>
          <div className="grid grid-cols-1 place-items-start justify-between gap-12 lg:grid-cols-3">
            <div className="col-span-1 mx-auto flex flex-col items-center justify-center">
              <Image
                ...
                width={400}
                height={498}
                className="h-auto w-72 -rotate-1 hover:rotate-6"
              />
